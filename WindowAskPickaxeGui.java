...
public class WindowAskPickaxeGui extends JFrame {
    ...
    public WindowAskPickaxeGui(ArrayList<Tile> Land, PlowTool plowTool, Farm farm,
    Pickaxe pickaxe, Player player){
        ...
        btnConfirm.addMouseListener(new MouseListener(){
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (chosenTileNum < 0 || chosenTileNum >= Land.size()) {
                    ...
                    pickaxe.RemoveRock(Land, chosenTileNum, player);
                }
                dispose();
            }
