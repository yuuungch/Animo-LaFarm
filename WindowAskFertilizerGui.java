...
public class WindowAskFertilizerGui extends JFrame {
    ...
    public WindowAskFertilizerGui(ArrayList<Tile> Land, PlowTool plowTool, Farm farm,
            Fertilizer fertilizer, Player player) {
        ...
        btnConfirm.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (chosenTileNum < 0 || chosenTileNum >= Land.size()) {
                    ...
                    fertilizer.Fertilize(Land, chosenTileNum, player);
                }
                dispose();
            }
