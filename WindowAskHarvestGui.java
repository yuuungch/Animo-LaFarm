...
public class WindowAskHarvestGui extends JFrame {
    ...
    public WindowAskHarvestGui(ArrayList<Tile> Land, PlowTool plowTool, Farm farm,
    Player player){
        ...
        btnConfirm.addMouseListener(new MouseListener(){
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (chosenTileNum < 0 || chosenTileNum >= Land.size()) {
                    ...
                    farm.harvest(Land, chosenTileNum, player);
                }
                dispose();
            }
